...
if pesan.islower() or key.islower():
    ...
    print("\n=========================")
    print("Pesan:", pesan)
    print("Relatif terhadap 'A':", [ord(c) - ord('A') for c in pesan])
    print("Key:", key)
    print("Relatif terhadap 'A':", [ord(c) - ord('A') for c in key])
    print("Enkripsi:", pesan_enkripsi)
    print("Relatif terhadap 'A':", [ord(c) - ord('A') for c in pesan_enkripsi])

    # Deskripsi
    pesan_deskripsi = vigenere_cipher(pesan_enkripsi, key, 'deskripsi')
    print("Deskripsi:", pesan_deskripsi)
    print("Relatif terhadap 'A':", [ord(c) - ord('A') for c in pesan_deskripsi])
